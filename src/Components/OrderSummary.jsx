...
//     return subtotal + promoCode;
//   };

//   const totalItems = cart.reduce((total, item) => total + item.quantity, 0); // Total number of items

//   // Check if promo code can be applied
//   const checkPromoCode = (event) => {
//     event.preventDefault();

//     const total = totalPrice(); // Get the total price after items subtotal and any existing promo code discount

//     // Promo code logic
//     if (total <= 200) {
//       setErrorAlert(true); // Show error if total price is less than or equal to 200
//       return;
//     }

//     // Validate the promo code 'VSF2020'
//     if (inputValue.toUpperCase() === 'VSF2020') {
//       setPromoCode(-100); // Apply the $100 discount
//       setPositiveAlert(true); // Show success alert
//     } else {
//       setErrorAlert(true); // Show error for invalid promo code
//     }
//   };

//   const removePromoCode = () => {
//     setPromoCode(0);
//     setInformationAlert(true); // Show info alert when promo code is removed
//   };
...
//           <p className="typography-text-base font-medium">(Items: {totalItems})</p>
//         </div>
...
//               <p>{formatPrice(0)}</p> {/* Assuming no extra delivery charge */}
//             </div>
//           </div>
...
//       {/* Alerts */}
//       <div className="absolute top-0 right-0 mx-2 mt-8 sm:mr-6">
//         {positiveAlert && (
//           <div
//             role="alert"
...
//             <p className="py-2 mr-2">Your promo code has been applied.</p>
//             <button
//               type="button"
...
//               {totalPrice() <= 200
//                 ? 'Promo code is only applicable for total amounts above $200.'
//                 : 'Invalid promo code.'}
//             </p>
//             <button
//               type="button"
...
const OrderSummary = () => {
  ...
  return (
    <div className="relative md:shadow-lg md:rounded-md md:border md:border-neutral-100">
      <div className="flex justify-between items-end bg-neutral-100 md:bg-transparent py-2 px-4 md:px-6 md:pt-6 md:pb-4">
        <p className="typography-headline-4 font-bold md:typography-headline-3 text-lg md:text-2xl">
          Order Summary
        </p>
        <p className="typography-text-base font-medium text-sm md:text-base">
          (Items: {totalItems})
        </p>
      </div>
